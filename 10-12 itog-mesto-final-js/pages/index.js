...
import { initialCards, editButton, addButton, popName, popUpdescription, formElementAccount, nameInput, jobInput, formElementCard, formElementAvatar, avatarImage, authorizationToken } from "../components/utils/constants.js";
...
const userDataId = await api.getUserData();
...
function createCard(item) {
  const newCard = new Card(
    {
      data: item,
      userId: userId, //userId   userDataId._id
